...
center ->
	h2 ->
		a href: "https://www.youtube.com/playlist?list=PLz5OOfv8ZWBGSjSH0PQ3TJ_e4cn9ogaXl", -> "Dark World Time Trial Videos"
...
#	h3 ->
#		a href: @site.url + "video/dreadwood-2_1-908.mp4", -> "Dreadwood-2 (1.908s)"
#	h3 ->
#		a href: @site.url + "video/darkfang-1_1-954.mp4", -> "Darkfang-1 (1.954s)"
#	h3 ->
#		a href: @site.url + "video/darkfang-2_2-484.mp4", -> "Darkfang-2 (2.484s)"
#	h3 ->
...
#		a href: @site.url + "video/cataclysm-2_2-111.mp4", -> "Cataclysm-2 (2.111s)"
	h2 ->
		a href: "http://drskipper7.tumblr.com/", -> "Versus Replays"
